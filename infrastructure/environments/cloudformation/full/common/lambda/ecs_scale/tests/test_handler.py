...
from ecs_scale.handler import lambda_handler
import logging
...
class TestLambdaHandler(unittest.TestCase):
    ...
    def test_lambda_handler(self, mock_boto_client, mock_get_env):
        ...
        mock_get_env.side_effect = (
            "prod",  # Return 'stag' for 'ENVIRONMENT'
        ...
        }  # You can provide a sample event here if needed
